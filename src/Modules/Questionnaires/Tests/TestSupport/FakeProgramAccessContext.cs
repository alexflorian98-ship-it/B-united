...
/// <summary>Test double for Billing's cross-module <see cref="IProgramAccessContext"/> —
/// Questionnaires' tests configure ownership directly rather than depending on Billing's real
/// purchase flow (CLAUDE.md: never reference another module's Domain/Infrastructure). Mirrors
/// Progress's/Content's identically named <c>FakeProgramAccessContext</c>.</summary>
