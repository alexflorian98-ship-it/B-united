...
/// <summary>Test double for Content's cross-module <see cref="IProgramLookup"/> — Questionnaires'
/// tests must never depend on Content's real Domain/Infrastructure (CLAUDE.md), so program
/// existence/publish state is configured directly by the test instead. Mirrors Billing's
/// identically named <c>FakeProgramLookup</c>.</summary>
