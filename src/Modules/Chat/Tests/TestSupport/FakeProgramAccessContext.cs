...
/// <summary>Test double for Billing's cross-module <see cref="IProgramAccessContext"/> — Chat's
...
/// Progress's/Content's/Questionnaires'/Events' identically named <c>FakeProgramAccessContext</c>.</summary>
