...
public sealed class UpsertQuizQuestionTranslationValidator : AbstractValidator<UpsertQuizQuestionTranslationRequest>
{
    public UpsertQuizQuestionTranslationValidator()
    {
